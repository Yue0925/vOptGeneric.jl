...
f1RL, xf1RL = computeLinearRelax(nbvar, nbctr, A, b, c, typemax(Int), 1) # opt fct 1
minf1RL, maxf2RL = evaluerSolution(xf1RL, c)

# calcule la valeur optimale relachee de f2 seule et le point (z1,z2) correspondant
f2RL, xf2RL = computeLinearRelax(nbvar, nbctr, A, b, c, typemax(Int), 2) # opt fct 2
...
nbgen, L = calculGenerateurs(A, c, tailleSampling, minf1RL, maxf2RL, maxf1RL, minf2RL, d)
